    ...
    <body>
        ...
        <div class="b-banner fullscreen" id="b-banner">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-5 wow fadeInLeft">
                        <div class="author-thumb text-center">
                            <img src="<?= base_url(); ?>assets/img/about.jpg" class="img-thumbnail">
                        </div>
                    </div>
        ...
        <div id="process" class="process section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="proecess-block col-xs-12 col-sm-6 col-md-6">
