<div class="container fluid">
	...
	<table class="table table-bordered m-1">
		...
		<tr>
            ...
            <th><img src="<?= base_url().'/uploads/'.$brg->detail1 ?>" width=50></th>
            <th><img src="<?= base_url().'/uploads/'.$brg->detail2 ?>" width=50></th>
            <th><img src="<?= base_url().'/uploads/'.$brg->detail3 ?>" width=50></th>
			<th><?= $brg->nama_brg ?></th>
                            ...
                            <div class="row">
                            	<div class="col-sm-9">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="gambar">Choose file (Thumbnail)</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-9">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="detail1" name="detail1">
                                        <label class="custom-file-label" for="gambar">Choose file (Detail 1)</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-9">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="detail2" name="detail2">
                                        <label class="custom-file-label" for="gambar">Choose file (Detail 2)</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-9">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="detail3" name="detail3">
                                        <label class="custom-file-label" for="gambar">Choose file (Detail 3)</label>
                                    </div>
                                </div>
                            </div>
                        </div>
